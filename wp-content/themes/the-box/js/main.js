...
$(window).load(function() {
    ...
    if(isMobile) preload([
//        URLS.stylesheet + '/images/ui/mobile/readmore.png', URLS.stylesheet + '/images/ui/mobile/aboutvid.png', URLS.stylesheet + '/images/ui/mobile/archive.png', URLS.stylesheet + '/images/ui/mobile/audio.png', URLS.stylesheet + '/images/ui/mobile/citation.png', URLS.stylesheet + '/images/ui/mobile/magazine.png', URLS.stylesheet + '/images/ui/mobile/continue.png', URLS.stylesheet + '/images/ui/mobile/draugiem.png', URLS.stylesheet + '/images/ui/mobile/fb.png', URLS.stylesheet + '/images/ui/mobile/gallery.png', URLS.stylesheet + '/images/ui/mobile/gallery_control.png', URLS.stylesheet + '/images/ui/mobile/gallery_counter.png', URLS.stylesheet + '/images/ui/mobile/gallery_loading.gif', URLS.stylesheet + '/images/ui/mobile/gplus.png', URLS.stylesheet + '/images/ui/mobile/header_pattern.png', URLS.stylesheet + '/images/ui/mobile/humor.png', URLS.stylesheet + '/images/ui/mobile/line_pattern.png', URLS.stylesheet + '/images/ui/mobile/menu_toggle.png', URLS.stylesheet + '/images/ui/mobile/navtree_bg.png', URLS.stylesheet + '/images/ui/mobile/navtree_bg1.png', URLS.stylesheet + '/images/ui/mobile/navtree_end.png', URLS.stylesheet + '/images/ui/mobile/objects.png', URLS.stylesheet + '/images/ui/mobile/popup_close.png', URLS.stylesheet + '/images/ui/mobile/readmore.png', URLS.stylesheet + '/images/ui/mobile/readmore_big.png', URLS.stylesheet + '/images/ui/mobile/slideout_bg.png', URLS.stylesheet + '/images/ui/mobile/slideout_bg_flip.png', URLS.stylesheet + '/images/ui/mobile/twitter.png'
    ]);
    else preload([
        URLS.stylesheet + '/images/ui/readmore_big.png', URLS.stylesheet + '/images/ui/aboutvid.png', URLS.stylesheet + '/images/ui/archive.png', URLS.stylesheet + '/images/ui/audio.png', URLS.stylesheet + '/images/ui/citation.png', URLS.stylesheet + '/images/ui/magazine.png', URLS.stylesheet + '/images/ui/continue.png', URLS.stylesheet + '/images/ui/draugiem.png', URLS.stylesheet + '/images/ui/fb.png', URLS.stylesheet + '/images/ui/gallery.png', URLS.stylesheet + '/images/ui/gallery_control.png', URLS.stylesheet + '/images/ui/gallery_counter.png', URLS.stylesheet + '/images/ui/gallery_loading.gif', URLS.stylesheet + '/images/ui/gplus.png', URLS.stylesheet + '/images/ui/header_pattern.png', URLS.stylesheet + '/images/ui/humor.png', URLS.stylesheet + '/images/ui/line_pattern.png', URLS.stylesheet + '/images/ui/menu_toggle.png', URLS.stylesheet + '/images/ui/navtree_bg.png', URLS.stylesheet + '/images/ui/navtree_bg1.png', URLS.stylesheet + '/images/ui/navtree_end.png', URLS.stylesheet + '/images/ui/objects.png', URLS.stylesheet + '/images/ui/popup_close.png', URLS.stylesheet + '/images/ui/readmore.png', URLS.stylesheet + '/images/ui/readmore_big.png', URLS.stylesheet + '/images/ui/slideout_bg.png', URLS.stylesheet + '/images/ui/slideout_bg_flip.png', URLS.stylesheet + '/images/ui/twitter.png'
    ]);
...
//        $('.button-wrap').css('top', '85%');
//        $('.game-content').height($(window).height());
//        $('.game-content').height($('#page').height);
...
//    $('body').prepend('<div id="fb-root"></div>');
    ...
    if (!isMobile) {
        ...
        $('#msidemenu div, #contlink').on('click', function(event) {
            event.stopPropagation();
            //$(this).removeAttr('href');
            var element = $(this).parent('li');
            if (element.hasClass('open')) {
                ...
                element.siblings('li').find('li').removeClass('open');
                element.siblings('li').find('ul').slideUp();
//                setTimeout(function(){$('#msidemenu .open').last()[0].scrollIntoView();}, 500);
            }
...
function init() {
    ...
    $(document).on('click', '#menu_toggle', function(event) {
        ...
        if (element.css('display') === 'none') {
            element.css('top', $('#masthead').height());
            element.slideDown();
        } else {
            element.slideUp();
        }
...
//    $('.game-content > div').css('top', $('#masthead').height());    
    ...
    $(document).on('click', '.readmore, .mejs-textform, .humortext.cboxElement, .pic_single', function() {        
        ...
        $(document).bind('cbox_complete', function() {
            ...
            $('#colorbox .citation_logo').show();
            if (popupBtn.hasClass('gallery')){
                $('#colorbox .citation_logo').attr('id', 'galicon');
            }
            else if (popupBtn.hasClass('archive')){
                $('#colorbox .citation_logo').attr('id', 'archicon');
            }
            else if (popupBtn.hasClass('objects')){
                $('#colorbox .citation_logo').attr('id', 'objicon');
            }
            else if (popupBtn.hasClass('humor')){
                $('#colorbox .citation_logo').attr('id', 'humicon');
            }
            else if (popupBtn.hasClass('magazine')){
...
//                $('#lg-counter').css('margin-left', $('.pictoolbar').width()/2);// + ($('.pictoolbar').width() - $('.pictoolbar div').width()*3)/4); 
                $('#lg-counter').css('line-height', $('#lg-counter').height() + "px");
...
//                     $('#cboxLoadedContent #vidicon').remove();
                    ...
                    if(typeof div !== "undefined") div.parentNode.removeChild(div);
                }
...
//                     $('#cboxLoadedContent #vidicon').remove();
        ...
        $(document).bind('cbox_closed', function() {
//            $('.citation_logo').remove();
            var div = $('#colorbox .citation_logo')[0];
...
$(document).bind('cbox_closed', function() {
    ...
    $(document).on('click', '.pic_gallery', function() {
        ...
        if (popupBtn.hasClass('gallery')){
                $('.lg-outer .citation_logo').attr('id', 'galicon');
            }
            else if (popupBtn.hasClass('archive')){
                $('.lg-outer .citation_logo').attr('id', 'archicon');
            }
            else if (popupBtn.hasClass('objects')){
                $('.lg-outer .citation_logo').attr('id', 'objicon');
            }
            else if (popupBtn.hasClass('humor')){
                $('.lg-outer .citation_logo').attr('id', 'humicon');
            }
            else if (popupBtn.hasClass('magazine')){
                $('.lg-outer .citation_logo').attr('id', 'cloicon');
            }
...
function m_showMenu() {
    $('#msidemenu').height($('#page').height()-$('#masthead').height());
    $('#msidemenu').css('top', $('#masthead').height());
    event.stopPropagation();
    var element = $('#msidemenu');
...
function m_setVideo() {
    ...
    $('.video-content div').first().prepend('<div id="vidicon"></div>');
...
function scrollToImage(){
    if($('.alignleft').length>0)
        $('.mcit').animate({
            scrollLeft: $(window).width()*0.13 + ($('.mcit img').width()-$(window).width())/2
        }, 750);
    else if ($('.alignright').length>0){
        $('.mcit').animate({
            scrollLeft: $(window).width()*0.2 + parseInt($('.alignright').css('margin-left')) + ($('.mcit img').width()-$(window).width())/2
        }, 750);
    }
}
...
//    var item = dynamicContent.getItem();
//    if(lang !== "")
//        console.log(NAVIGATION[item.menu_order-1]);
//    window.location.href = URLS.site + lang + '#' + item.post_name + '-en';
//console.log(NAVIGATION[item.menu_order-1]);
////    item = NAVIGATION[item.menu_order-1]
////    content.draw(dynamicContent.getItem);
//}
