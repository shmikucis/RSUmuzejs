...
function mInit(){
    ...
    $("#menu_toggle").remove();
    $("#masthead").append('<div id="m_srchbtn"></div>')
}
...
function mContinue(){
    console.log($("#mobileButZone #bigmore").width(),$(window).width());
    $("#bigmore").css("margin-left", ($(window).width()-$("#mobileButZone #bigmore").width())/2);
}